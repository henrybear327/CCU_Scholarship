            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <form class="form-horizontal" method="POST" action="{{ url('administrator/capSetting') }} ">
                        ...
                        <td><input type="text" name="tuition_cap" class="form-control" id="email"
                                   placeholder="請輸入上限金額(元）"></td>
                        <td><input type="text" name="miscellaneousFees_cap" class="form-control" id="email"
                                   placeholder="請輸入上限金額(元）"></td>
                        <td><input type="text" name="accommodation_cap" class="form-control" id="email"
                                   placeholder="請輸入上限金額(元）"></td>
                        <td><input type="text" name="cost_of_living_cap" class="form-control" id="email"
                                   placeholder="請輸入上限金額(元）"></td>
                        <td>
